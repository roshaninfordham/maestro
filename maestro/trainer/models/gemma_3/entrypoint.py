...
from maestro.trainer.models.gemma_3.core import Gemma3Configuration
from maestro.trainer.models.gemma_3.core import train as gemma_3_train

logger = get_maestro_logger()
gemma_3_app = typer.Typer(help="Fine-tune and evaluate Gemma-3 model")


@gemma_3_app.command(
    help="Train Gemma-3 model", context_settings={"allow_extra_args": True, "ignore_unknown_options": True}
)
def train(
    dataset: Annotated[
        str,
    ...
    model_id: Annotated[
        str, typer.Option("--model_id", help="Identifier for the Gemma-3 model")
    ] = DEFAULT_GEMMA3_MODEL_ID,
    revision: Annotated[str, typer.Option("--revision", help="Model revision to use")] = DEFAULT_GEMMA3_MODEL_REVISION,
